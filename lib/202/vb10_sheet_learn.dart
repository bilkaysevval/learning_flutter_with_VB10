...
//
mixin ProductSheetMixin { // made this for using another project
...
class _CustomMainSheet extends StatelessWidget { // made this for using another project
...
class _BaseSheetHeader extends StatelessWidget {  // for widget above
